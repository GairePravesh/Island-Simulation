...
// pseudorandom gradient function
vec2 g(vec2 p) {
...
// the frequency multiplier between octaves - lacunarity
// gain - amplitude 
...
// a different, less eroded kind of mountainous terrain is approximated. 
...
// a more ‘billowy’ and eroded terrain with sharp creases can be created. 
